...
describe("Form", () => {
  ...
  //access student name input with getByPlaceholderText
  it("renders without student name if not provided", () => {
    const { getByPlaceholderText } = render(<Form interviewers={interviewers} />);
    expect(getByPlaceholderText("Enter Student Name")).toHaveValue("");
  });
  //access student name input, same element in the DOM with getByTestId
  ...
  //   // getByText() will throw an error if the text isn't found in the document, whereas queryByText() will return null and let you continue with your testing 
  ...
  //   //toHaveBeenCalledTimes to check number of times mock fn has been called single argument (number)
  //   //toHaveBeenCalledWith check mock fn number of times with specific arguments(more than one argument)
  ...
  //replace two tests above with this one, more useful and covers the two above
